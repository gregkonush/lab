...
const buildImplementationPrompt = ({
  ...
  return [
    ...
    `- Maintain a single progress comment anchored by ${PROGRESS_COMMENT_MARKER} using apps/froussard/scripts/codex-progress-comment.ts (kickoff checklist, milestone updates, final summary).`,

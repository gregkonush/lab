              ...
              <div className="relative z-10 flex flex-col h-full">
                <CardHeader className="flex-none">
                  <div className="flex items-center justify-between mb-2">
                    <span
                      className={cn(
                        'select-none px-3 py-1 rounded-full text-xs font-semibold',
                        {
                          'bg-indigo-950/80 text-indigo-200 ring-1 ring-indigo-800/30':
                            item.category === 'AI',
                          'bg-emerald-950/80 text-emerald-200 ring-1 ring-emerald-800/30':
                            item.category === 'Tech',

        ...
        <div className="mx-auto flex max-w-4xl flex-col items-center text-center sm:flex-row sm:items-start sm:text-left">
          <div className="sm:flex-1">
            ...
            <p className="mt-3 text-sm text-muted-foreground sm:text-base">
              As devtools infrastructure for AI agents, the control plane
              stitches every capability together. Every pillar ships with secure
              defaults, deep observability, and zero vendor lock‑in.
            </p>
          </div>
        </div>

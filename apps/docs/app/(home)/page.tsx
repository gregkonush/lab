        ...
        <section className="flex flex-col items-center gap-6 text-center">
          ...
          <div className="flex max-w-3xl flex-col gap-4">
            ...
            <p className="text-base text-fd-muted-foreground sm:text-lg">
              Welcome to the home for the proompteng platform. Discover how to
              orchestrate prompts, automate evaluations, and operate safely from
        ...
        <section className="flex flex-col gap-4">
          <div className="flex flex-col gap-2">
            ...
            <p className="text-sm text-fd-muted-foreground">
              A shared language for product, engineering, and safety teams to
              build prompt-driven features together.
            </p>
          </div>
        ...
        <section className="grid gap-10 lg:grid-cols-[1.2fr,0.8fr]">
          <div className="rounded-2xl border border-fd-border bg-fd-card p-8 shadow-sm">
            ...
            <p className="mt-2 text-sm text-fd-muted-foreground">
              Follow the essentials to get a workspace online in minutes. Every
              step links deeper guidance inside the docs.
            </p>
          ...
          <div className="rounded-2xl border border-fd-border bg-fd-card p-8 shadow-sm">
            ...
            <p className="mt-2 text-sm text-fd-muted-foreground">
              Head straight to the topics people reference most during
              onboarding, reviews, and production launches.
            </p>
